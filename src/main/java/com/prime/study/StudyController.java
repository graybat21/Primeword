...
public class StudyController {
	...
	public String ready(@ModelAttribute @PathVariable String grade, @ModelAttribute @PathVariable String textbook,
			@PathVariable String lesson, HttpSession session) {
...
//		mav.addObject("list", list.size());
	...
	public String test(@ModelAttribute @PathVariable String grade,
			@ModelAttribute @PathVariable String textbook, @PathVariable String lesson, String knownWords, HttpSession session)
			throws Exception {
		Remember remember = new Remember();
		User user=(User)session.getAttribute("USER");
