	...
	function pageLink(p){
		...
		if(endPage == page){
			changeHeight = 32 * (endCount - (page - 1) * 15);
		 	...
		 	/* J('.transform-active').css("transform","translate(0px, 550px)"); */
		}
				...
				<div id="box" class="box transform" onclick="changebox()"></div>
					...
					<div class="btn_area">
						...
						<div class="btn">
							...
							<form action="<c:url value="/Study/${grade}/${textbook}" />" name="goNextLesson">
							...
							<!-- 다음스텝으로 가는 버튼 done -->
							<a href="javascript:goNextLesson.submit();">
