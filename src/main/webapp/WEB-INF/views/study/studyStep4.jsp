...
<script>
	...
	function pageLink(p){
		...
		if(endPage == page){
			changeHeight = 32 * (endCount - (page - 1) * 15);
...
<style>
/* 가림판 */
#main_bg44 .content_area .main_content .box {
  position:absolute;
...
#main_bg44 .content_area .main_content .transform {
    -webkit-transition-duration:10s;
    transition-timing-function:linear;
	height: 550px;
}

#main_bg44 .content_area .main_content .transform-active { 
				...
				<div id="box" class="box transform" onclick="changebox()"></div>
					...
					<div class="btn_area">
						...
						<div class="btn">
							...
							<form action="<c:url value="/Study/${grade}/${textbook}/${lesson }/ready5" />" name="goStep5">
							...
							<!-- 다음스텝으로 가는 버튼 done -->
							<a href="javascript:goStep5.submit();">
